...
📁 equipamentos/     → Impressoras térmicas, roteadores, nobreaks, etc.
```
...
| Documento | Conteúdo |
|---|---|
| [Visão Geral](SAG/visao-geral.md) | Estrutura do sistema, módulos, atalhos globais |
| [Caixa / Frente de Caixa](SAG/caixa.md) | Abertura, vendas, pagamentos, fechamento |
| [Cadastros](SAG/cadastros.md) | Clientes, fornecedores, produtos, usuários |
